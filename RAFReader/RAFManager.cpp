...
RAFManager *RAFManager::instance = NULL;

RAFManager *RAFManager::getInstance()
{ 
    if(instance == NULL)
...
void RAFManager::extractRAF(std::ifstream &file_table, std::ifstream &file_data)
{
...
void RAFManager::extractAllRAF(const char *path)
{
